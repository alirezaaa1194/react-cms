    ...
    <>
      <aside className={`fixed ${props.sidebarOpen === true ? "left-4" : "-left-full"} lg:left-4 w-[230px] h-full overflow-y-auto z-10 bg-white transition-all`}>
        <nav>
          ...
          <ul className="pl-2">
            <li className="my-1">
              <NavLink to="react-cms/home" className="flex items-center gap-x-2 w-full text-[15px] p-1 rounded-md text-[#71727D] transition-colors hover:bg-[#F1F1FE]">
          ...
          <ul className="pl-2">
            <li className="my-1">
              <NavLink to="react-cms/users" className="flex items-center gap-x-2 w-full text-[15px] p-1 rounded-md text-[#71727D] transition-colors hover:bg-[#F1F1FE]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
            ...
            <li className="my-1">
              <NavLink to="react-cms/NewUser" className="flex items-center gap-x-2 w-full text-[15px] p-1 rounded-md text-[#71727D] transition-colors hover:bg-[#F1F1FE]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                </svg>
                New User
            ...
            <li className="my-1">
              <NavLink to="react-cms/products" className="flex items-center gap-x-2 w-full text-[15px] p-1 rounded-md text-[#71727D] transition-colors hover:bg-[#F1F1FE]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
